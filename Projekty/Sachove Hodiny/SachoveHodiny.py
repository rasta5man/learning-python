...
class Hodiny:
    ...
    def nazov(self):
        self.canvas.create_text(250, 30, text = 'Sachove hodiny', font='arial 40', fill = 'blue')
    ...
    def casovac(self):
        if self.bezi:
            if self.cas == 0:
                self.canvas.create_text(250, 200, text = 'Cas vyprsal', font='arial, 50', fill = 'red')
                self.bezi = False
                Hodiny.pole[Hodiny.i%2].bezi = False
